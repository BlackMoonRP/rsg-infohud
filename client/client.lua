...
CreateThread(function()
    while true do
        ...
        if isLoggedIn and incinematic == false and inBathing == false and showUI and Config.ShowInfoHud == true then
            DrawTxt("ID : "..tonumber(GetPlayerServerId(PlayerId())).."  - Time : "..string.format("%0.2d", GetClockHours())..":"..string.format("%0.2d", GetClockMinutes()), 0.01, 0.97, 0.4, 0.4, true, 255, 255, 255, 255, true)
        end
    end
end)
